...
python ./scripts/plot.py 10x-2src/cca.36 --link-ppt 0.237 9.49 --num-points 9 --delay 150 --nsenders 2  --mean-on 5000 --mean-off 5000 --results-dir plot-10x-2src-1e6 --no-console-output-files
